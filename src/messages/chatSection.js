...
const ChatSection = ({ navigation, route }) => {
  ...
  const fetchTokensForCalls = async (type, isGroup) => {
    ...
    if (isGroup) {
      const response = await groupCall(friendId, userInfo?.memberToken, userInfo?.LoginToken, type === 'audio' ? 'voice' : 'video');
      if (response) {
      ...
      <>
        <IOScrollView>
          ...
          <Text
            ...
            {isCurrentUser && <Image style={{ width: responsiveWidth(5), height: responsiveWidth(5) }} source={require('../assets/png/check-double-fill.png')} />}{messageTime}
          </Text>
        </IOScrollView>
      </>
    );
        ...
        <View style={styles.chatHead}>
          <View style={styles.chatTop}>
            {!isPopupVisible && !imgPopupVisible ? (
              <TouchableOpacity onPress={() => navigation.goBack()}>
                <Image
                  style={{ width: 25, height: 25, marginBottom: 5, tintColor: 'white' }}
          ...
          {isPopupVisible ? (
            ...
            <View style={styles.callSection}>
              ...
              >
                <Image
                  style={{ width: responsiveWidth(4), height: responsiveWidth(4.5) }}
              ...
              >
                <Image
                  style={{ width: responsiveWidth(4), height: responsiveWidth(3) }}
          ...
          <View style={{ height: responsiveHeight(85.5) }}>
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              <View style={styles.emptymsg}>
                <Image style={{ width: responsiveWidth(23), height: responsiveWidth(23), borderRadius: responsiveWidth(15) }} source={require('../assets/png/user3.png')} />
                <Text style={{ fontSize: responsiveFontSize(2.5), color: 'black' }}>Sophia Williams</Text>
                <Text style={{ fontSize: responsiveFontSize(1.8), color: '#1866B4' }}>Sr. Data Analyst</Text>
                <View style={styles.emptymsgCont}>
                  <Text style={{ fontSize: responsiveFontSize(1.8), color: 'black' }}>Eager to learn and grow in the field of data science.</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: responsiveWidth(5), marginTop: responsiveWidth(1) }}>
                    <Text style={{ fontSize: responsiveFontSize(1.8), color: 'black' }}>Joined January 2024</Text>
                    <Image style={{ width: responsiveWidth(3), height: responsiveWidth(3) }} source={require('../assets/png/dott.png')} />
                    <Text style={{ fontSize: responsiveFontSize(1.8), color: 'black' }}>24.5K followers</Text>
                  </View>
                </View>
              </View>
              <View style={{height: responsiveHeight(50), justifyContent: 'center'}}>
                <View style={styles.endToend}>
                  <Image style={{ width: responsiveWidth(25), height: responsiveWidth(25), marginBottom: responsiveWidth(3) }} source={require('../assets/png/CustomIcon.png')} />
                  <Text style={{ fontSize: responsiveFontSize(1.5), textAlign: 'center' }}>
                    Messages and calls are end-to-end encrypted. No one outside of this chat, not even ACTPAL, can read or listen to them. Tap to learn more.
                  </Text>
                </View>
              </View>
            </View>
        ...
        <View style={[styles.sendBox, { width: width }]}>
          {showButtons && (
            <View style={styles.leftAreaBtn}>
              ...
              >
                <Text style={{ fontSize: responsiveFontSize(4), color: 'white', fontWeight: '500', lineHeight: 42 }}>+</Text>
              </TouchableOpacity>
              {/* <TouchableOpacity
