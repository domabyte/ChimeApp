        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={styles.profileSection}>
                    ...
                    <Text numberOfLines={1} style={styles.userName}>Brooklyn Simmons</Text>
                    <Text numberOfLines={1} style={styles.userTitle}>Developer</Text>
                ...
                <View style={styles.followingBtnArea}>
                    <TouchableOpacity style={[styles.followingBtn, {backgroundColor: '#1866B4'}]}>
                        <Text style={{color: 'white'}}>Following</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.followingBtn, {borderColor: '#1866B4', borderWidth: 1}]}>
