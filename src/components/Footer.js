        ...
        <View style={styles.main}>
          <TouchableOpacity
            ...
            <Image
              style={[
                styles.icon,
                {tintColor: selectTab == 0 ? null : '#99A0AE'},
              ]}
          ...
          <TouchableOpacity
            ...
            <Image
              style={[
                styles.icon,
                {tintColor: route.name == 'findFriends' ? null : '#99A0AE'},
              ]}
          ...
          <TouchableOpacity
            ...
            style={[styles.buttons, {position: 'relative'}]}>
            <Text style={styles.smsActive}>5</Text>
            <Image
              style={[
                styles.icon,
                {tintColor: route.name == 'allMessages' ? null : '#99A0AE'},
              ]}
          ...
          <TouchableOpacity
            ...
            <Text
              style={[
                styles.text,
                {color: route.name == 'myProfile' ? '#fff' : '#99A0AE'},
              ]}>
              ACCOUNT
            </Text>
          </TouchableOpacity>
